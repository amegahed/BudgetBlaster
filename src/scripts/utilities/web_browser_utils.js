...
//
// window positioning method
//


function getWindowLeft(element) {
  var left = 0;
  ...
  for (i = 0; i < document.styleSheets.length; i++)
    if (document.styleSheets[i].rules) {
      for (j = 0; j < document.styleSheets[i].rules.length; j++) 
        if (document.styleSheets[i].rules[j].selectorSprite == rule)
          return document.styleSheets[i].rules[j].style;
    } else {
      for (j = 0; j < document.styleSheets[i].cssRules.length; j++) 
        if (document.styleSheets[i].cssRules[j].selectorSprite == rule)
